...
//  float gyroZ_n = (gyroZ + 2000)/4000;
  ...
  s1 = mpr1.readPressure();
  //Serial.print(" KPa_1     ");

  pcaselect(1);

  s2 = mpr2.readPressure();
  //Serial.print(" KPa_2     ");

  pcaselect(2);

  s3 = mpr3.readPressure();
  //Serial.print(" KPa_3     ");

  pcaselect(3);
  s4 = mpr4.readPressure();
  //Serial.println(" KPa_4");

//  s1 = (current_value_1 - baseline_value_1);
//  s2 = (current_value_2 - baseline_value_2);
//  s3 = (current_value_3 - baseline_value_3);
//  s4 = (current_value_4 - baseline_value_4);
...
//  float s_gz = gyroZ_n * s_n; // Calculate interaction feature s*gz
  ...
  Serial.print(s1); Serial.print("  "); Serial.print(s2); Serial.print("  "); Serial.print(s3); Serial.print("  "); Serial.print(s4); Serial.print("  "); Serial.println(s);
